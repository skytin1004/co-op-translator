...
from .azure_computer_vision import AzureComputerVisionConfig
...
class VisionConfig:
    ...
    @classmethod
    def get_vision_config(cls) -> Optional[Dict[str, Any]]:
        """
        Get the configuration for the available Vision provider.
        
        Returns:
            Dictionary with configuration values if a provider is available, None otherwise
        """
