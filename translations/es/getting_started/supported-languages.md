...
La tabla a continuación lista los idiomas actualmente soportados por **Co-op Translator**. Incluye códigos de idioma, nombres de idiomas y cualquier problema conocido asociado con cada idioma. Si desea añadir soporte para un nuevo idioma, por favor añada el código de idioma correspondiente, nombre y fuente apropiada en el archivo `font_language_mappings.yml` ubicado en `src/co_op_translator/fonts/` y envíe un pull request después de realizar las pruebas.
...
¿Interesado en añadir un nuevo idioma? Por favor siga la guía de contribución:

- Vea Contribuir: [Contribuir un nuevo idioma](../CONTRIBUTING.md#contribute-a-new-language)
