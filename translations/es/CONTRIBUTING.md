...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-08T16:00:07+00:00",
...
5. Revisa los archivos traducidos en `test_docs/translations` y `test_docs/translated_images` para verificar:
   ...
   - Que la estructura original del markdown se mantenga
...
> #### GitHub Codespaces
>
> Puedes ejecutar estas muestras virtualmente usando GitHub Codespaces sin necesidad de configuraciones adicionales.
>
...
>
> #### Ejecutar localmente usando VS Code Dev Containers
>
...
Usamos [Black](https://github.com/psf/black) como formateador de código Python para mantener un estilo consistente en todo el proyecto. Black es un formateador estricto que reformatea automáticamente el código Python para ajustarse al estilo Black.
...
1. Añade el idioma al mapeo de fuentes
   ...
   - Añade una entrada con:
     - `code`: código de idioma tipo ISO (ejemplo: `vi`)
...
4. Actualiza la documentación
   ...
   - No es necesario modificar `getting_started/README_languages_template.md`; se genera desde la lista soportada
...
Para asegurar consistencia y claridad en el historial de commits del proyecto, seguimos un formato específico para el mensaje final de commit cuando usamos la estrategia **Squash and Merge**.

Cuando un pull request (PR) se fusiona, los commits individuales se combinan en un solo commit. El mensaje final debe seguir el formato a continuación para mantener un historial limpio y consistente.
...
- **type**: Especifica la categoría del commit. Usamos los siguientes tipos:
  ...
  - `Build`: Para cambios relacionados con el sistema de construcción o dependencias, incluyendo actualizaciones en archivos de configuración, flujos de CI o Dockerfile.
...
Al hacer merge, asegúrate de que el mensaje final del commit siga el formato descrito arriba.
