...
3.  **Repository secrets** کے تحت، ہر مطلوبہ AI سروس سیکرٹ کے لیے **New repository secret** پر کلک کریں۔
    ...
    <img src="../../../../translated_images/ur/select-setting-action.3b95c915d6031159.webp" alt="سیکرٹس شامل کرنے کی جگہ" /> *(تصویری حوالہ: سیکرٹس کہاں شامل کرنے ہیں)*
...
<img src="../../../../translated_images/ur/permission-setting.ae2f02748b0579e7.webp" alt="اجازتوں کی ترتیب" />
