...
1. **Install** चुनें और उस अकाउंट या संगठन को चुनें जिसमें आपका टारगेट रिपॉजिटरी है।
    ...
    <img src="../../../../translated_images/hi/install-app.d0f0a24cbb1d6c93.webp" alt="ऐप इंस्टॉल करें">
...
1. **Only select repositories** चुनें और अपना टारगेट रिपॉजिटरी (जैसे `PhiCookBook`) चुनें। **Install** पर क्लिक करें। आपसे ऑथेंटिकेट करने के लिए कहा जा सकता है।
    ...
    <img src="../../../../translated_images/hi/install-authorize.29df6238c3eb8f70.webp" alt="इंस्टॉल ऑथराइज़ करें">
...
1. **Repository secrets** के तहत, नीचे दिए गए हर सीक्रेट के लिए **New repository secret** पर क्लिक करें।
   ...
   <img src="../../../../translated_images/hi/select-setting-action.3b95c915d6031159.webp" alt="सेटिंग एक्शन चुनें">
...
<img src="../../../../translated_images/hi/add-secrets-done.444861ce6956d5cb.webp" alt="एनवायरनमेंट वेरिएबल नाम दर्ज करें">
