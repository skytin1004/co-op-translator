...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-22T13:42:40+00:00",
...
- Crie um `.env` usando o modelo: [.env.template](../../.env.template)
...
- [Guia GitHub Actions (Repositórios de organização Microsoft & configurações a nível de organização)](./getting_started/github-actions-guide/github-actions-guide-org.md)
...
contacte [opencode@microsoft.com](mailto:opencode@microsoft.com) para questões ou comentários adicionais.
...
A abordagem da Microsoft à IA responsável baseia-se nos nossos princípios de IA: justiça, fiabilidade e segurança, privacidade e proteção, inclusão, transparência e responsabilidade.

Modelos de linguagem, imagem e voz em larga escala – como os usados neste exemplo – podem comportar-se de forma injusta, pouco fiável ou ofensiva, causando danos. Consulte a [nota de transparência do serviço Azure OpenAI](https://learn.microsoft.com/legal/cognitive-services/openai/transparency-note?tabs=text) para estar informado sobre riscos e limitações.

A abordagem recomendada para mitigar estes riscos é incluir um sistema de segurança na sua arquitetura que possa detetar e prevenir comportamentos prejudiciais. O [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) oferece uma camada independente de proteção, capaz de detetar conteúdo prejudicial gerado por utilizadores ou IA em aplicações e serviços. O Azure AI Content Safety inclui APIs de texto e imagem que permitem detetar material nocivo. Também temos um Content Safety Studio interativo que permite visualizar, explorar e experimentar código de exemplo para detetar conteúdo prejudicial em diferentes modalidades. A seguinte [documentação de início rápido](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text?tabs=visual-studio%2Clinux&pivots=programming-language-rest) guia-o na realização de pedidos ao serviço.
Outro aspeto a ter em conta é o desempenho geral da aplicação. Em aplicações multi-modal e multi-modelo, consideramos desempenho como o sistema funcionar conforme esperado por si e pelos seus utilizadores, incluindo não gerar resultados prejudiciais. É importante avaliar o desempenho da sua aplicação utilizando [métricas de qualidade de geração, risco e segurança](https://learn.microsoft.com/azure/ai-studio/concepts/evaluation-metrics-built-in).

Pode avaliar a sua aplicação de IA no ambiente de desenvolvimento usando o [prompt flow SDK](https://microsoft.github.io/promptflow/index.html). Com um conjunto de dados de teste ou um objetivo definido, as gerações da sua aplicação de IA generativa são medidas quantitativamente com avaliadores integrados ou personalizados à sua escolha. Para começar a usar o prompt flow sdk para avaliar o seu sistema, pode seguir o [guia rápido](https://learn.microsoft.com/azure/ai-studio/how-to/develop/flow-evaluate-sdk). Depois de executar uma avaliação, pode [visualizar os resultados no Azure AI Studio](https://learn.microsoft.com/azure/ai-studio/how-to/evaluate-flow-results).
...
[Diretrizes de Marcas & Imagem da Microsoft](https://www.microsoft.com/en-us/legal/intellectualproperty/trademarks/usage/general).
...
Se tiver dúvidas ou precisar de ajuda para criar aplicações de IA, junte-se a:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Se quiser dar feedback sobre o produto ou encontrar erros durante o desenvolvimento, visite:
