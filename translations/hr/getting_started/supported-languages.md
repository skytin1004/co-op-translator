...
Tablica u nastavku navodi jezike koje trenutno podržava **Co-op Translator**. Uključuje jezične kodove, nazive jezika i poznate probleme povezane s pojedinim jezicima. Ako želite dodati podršku za novi jezik, molimo dodajte odgovarajući jezični kod, naziv i odgovarajući font u datoteku `font_language_mappings.yml` koja se nalazi u `src/co_op_translator/fonts/` i pošaljite pull request nakon testiranja.
...
| fa            | Persijski (Farsi)    | NotoSansArabic-Medium.ttf         | Da          | Ne           |
...
| te            | Teluški              | NotoSans-Medium.ttf               | Ne          | Ne           |
| ml            | Malajalamski         | NotoSans-Medium.ttf               | Ne          | Ne           |
| kn            | Kannada              | NotoSans-Medium.ttf               | Ne          | Ne           |
| km            | Khmer                | NotoSansKhmer-Medium.ttf          | Ne          | Ne           |

## Dodavanje novog jezika

Zanima vas dodavanje novog jezika? Molimo slijedite vodič za doprinos:

- Pogledajte Contributing: [Contribute a new language](../CONTRIBUTING.md#contribute-a-new-language)
