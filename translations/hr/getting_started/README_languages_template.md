# 🌐 Višejezična podrška (Predložak)

Održavatelji: Blok ispod je primjer za "sve jezike" kojim upravlja Co-op Translator.

- Ako želite da Co-op Translator automatski održava ovaj popis potpuno ažurnim kad god pokrenete `translate` (bilo koji izbor jezika), ostavite ove dvije komentarske oznake nepromijenjene.
- Ako želite prikazati samo podskup jezika, izbrišite dvije komentarske oznake i uklonite jezike koje ne želite navesti. Nakon što uklonite oznake, Co-op Translator neće više automatski zamjenjivati ovaj odjeljak.

- Sekcija sada uključuje savjet "Preferirate li lokalno kloniranje?" kako bi se korisnicima omogućilo kloniranje bez velikog tereta prijevoda. Savjet možete prilagoditi s URL-om svog repozitorija pokretanjem, na primjer:
