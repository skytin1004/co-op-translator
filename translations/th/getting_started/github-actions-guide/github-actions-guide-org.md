...
1. เลือก **Install** และเลือกบัญชีหรือองค์กรที่มี repository เป้าหมายของคุณ
    ...
    ![Install app](../../../../translated_images/th/install-app.d0f0a24cbb1d6c93.webp)
...
1. เลือก **Only select repositories** แล้วเลือก repository เป้าหมายของคุณ (เช่น `PhiCookBook`) จากนั้นคลิก **Install** อาจมีการขอให้ยืนยันตัวตน
    ...
    ![Install authorize](../../../../translated_images/th/install-authorize.29df6238c3eb8f70.webp)
...
1. ใต้ **Repository secrets** คลิก **New repository secret** สำหรับแต่ละ secret ที่ระบุด้านล่าง
   ...
   ![Select setting action](../../../../translated_images/th/select-setting-action.3b95c915d6031159.webp)
...
![Enter environment variable name](../../../../translated_images/th/add-secrets-done.444861ce6956d5cb.webp)
