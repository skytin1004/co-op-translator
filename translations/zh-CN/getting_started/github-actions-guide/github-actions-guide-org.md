...
1. 选择**安装**，并选择您的目标仓库所在的账号或组织。
    ...
    <img src="../../../../translated_images/zh-CN/install-app.d0f0a24cbb1d6c93.webp" alt="Install app">

1. 选择**仅选择仓库**，并勾选您的目标仓库（如 `PhiCookBook`）。点击**安装**。可能需要进行身份验证。

    <img src="../../../../translated_images/zh-CN/install-authorize.29df6238c3eb8f70.webp" alt="Install authorize">
...
1. 在**Repository secrets** 下，为下表中的每个密钥点击**New repository secret**。
   ...
   <img src="../../../../translated_images/zh-CN/select-setting-action.3b95c915d6031159.webp" alt="Select setting action">
...
<img src="../../../../translated_images/zh-CN/add-secrets-done.444861ce6956d5cb.webp" alt="Enter environment variable name">
