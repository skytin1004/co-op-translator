...
Le tableau ci-dessous répertorie les langues actuellement prises en charge par **Co-op Translator**. Il inclut les codes de langue, les noms des langues et les éventuels problèmes connus associés à chaque langue. Si vous souhaitez ajouter la prise en charge d'une nouvelle langue, veuillez ajouter le code de langue correspondant, le nom et la police appropriée dans le fichier `font_language_mappings.yml` situé dans `src/co_op_translator/fonts/` et soumettre une pull request après avoir testé.
...
Intéressé à ajouter une nouvelle langue ? Veuillez suivre le guide de contribution :
