...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-11T08:06:23+00:00",
...
- Synchronisation des traductions avec les modifications de la source  
...
- [IA générative pour débutants avec Java](https://github.com/microsoft/generative-ai-for-beginners-java)  
...
Ce projet accueille contributions et suggestions. Vous souhaitez contribuer à Azure Co-op Translator ? Veuillez consulter notre [CONTRIBUTING.md](./CONTRIBUTING.md) pour connaître les directives et découvrir comment aider à rendre Co-op Translator plus accessible.
