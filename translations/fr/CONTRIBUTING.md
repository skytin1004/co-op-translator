...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-08T16:02:11+00:00",
...
2. Incluez les fichiers de police nécessaires (si besoin)
   - Si une nouvelle police est requise, vérifiez la compatibilité de licence pour la distribution open source
...
4. Mettez à jour la documentation
   ...
   - Aucune modification n’est nécessaire dans `getting_started/README_languages_template.md` ; il est généré à partir de la liste supportée
...
- **type** : spécifie la catégorie du commit. Nous utilisons les types suivants :
  ...
  - `Core` : pour les modifications du cœur du projet ou des fonctionnalités, notamment les fichiers dans le répertoire `src/co_op_translator/core`.
...
- Moins de bruit dû aux commits mineurs (ex. "correction de faute").
