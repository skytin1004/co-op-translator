...
> **Préférez cloner en local ?**
>
> Ce dépôt inclut plus de 50 traductions de langues ce qui augmente considérablement la taille du téléchargement. Pour cloner sans les traductions, utilisez le checkout épars :
>
> **Bash / macOS / Linux :**
> ```bash
