...
1. 點選 **Install**，選擇你的帳號或組織（即目標儲存庫所在位置）。
    ...
    <img src="../../../../translated_images/zh-MO/install-app.d0f0a24cbb1d6c93.webp" alt="安裝 app">

1. 選擇 **Only select repositories**，勾選你的目標儲存庫（如 `PhiCookBook`），然後點選 **Install**。可能會要求你驗證身份。

    <img src="../../../../translated_images/zh-MO/install-authorize.29df6238c3eb8f70.webp" alt="安裝授權">
...
1. 在 **Repository secrets** 下，針對下方每一個 secret 點選 **New repository secret**。
   ...
   <img src="../../../../translated_images/zh-MO/select-setting-action.3b95c915d6031159.webp" alt="選擇設定 action">
...
<img src="../../../../translated_images/zh-MO/add-secrets-done.444861ce6956d5cb.webp" alt="輸入環境變數名稱">
