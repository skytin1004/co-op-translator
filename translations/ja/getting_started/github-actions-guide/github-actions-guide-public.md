...
3. **Repository secrets**の下で、必要なAIサービスごとに**New repository secret**をクリックして追加します。
    ...
    <img src="../../../../translated_images/ja/select-setting-action.3b95c915d6031159.webp" alt="Select setting action">（画像説明: シークレット追加箇所）
...
<img src="../../../../translated_images/ja/permission-setting.ae2f02748b0579e7.webp" alt="Permission setting">
