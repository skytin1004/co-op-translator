...
Nasledujúca tabuľka uvádza jazyky, ktoré sú aktuálne podporované **Co-op Translator**. Obsahuje jazykové kódy, názvy jazykov a známe problémy spojené s každým jazykom. Ak chcete pridať podporu pre nový jazyk, pridajte príslušný jazykový kód, názov a vhodné písmo do súboru `font_language_mappings.yml` nachádzajúceho sa v `src/co_op_translator/fonts/` a po otestovaní predložte pull request.
...
| zh-HK         | Čínština (tradičná, Hong Kong) | NotoSansCJK-Medium.ttc  | Nie         | Nie          |
...
| bn            | Bengalčina           | NotoSansBengali-Medium.ttf        | Nie         | Nie          |
...
| pcm           | Nigérijská pidžinčina | NotoSans-Medium.ttf              | Nie         | Nie          |
...
- Pozrite si Prispievanie: [Prispieť novým jazykom](../CONTRIBUTING.md#contribute-a-new-language)
