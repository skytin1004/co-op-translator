...
Správcovia: Nižšie uvedený blok je príkladom „všetkých jazykov“ spravovaným Co-op Translator.

- Ak chcete, aby Co-op Translator túto zoznam automaticky aktualizoval pri spustení `translate` (ľubovoľný výber jazyka), ponechajte komentáre bezo zmeny.
- Ak chcete zobraziť iba podmnožinu jazykov, odstráňte oba komentáre a vymažte jazyky, ktoré nechcete uvádzať v zozname. Po odstránení komentárov už Co-op Translator túto sekciu automaticky nenahradí.

- Sekcia teraz obsahuje upozornenie „Preferujete lokálnu kópiu?“ na pomoc používateľom klonovať bez veľkého prekladačského balíka. Môžete upozornenie prispôsobiť pomocou URL vášho repozitára napríklad spustením:
