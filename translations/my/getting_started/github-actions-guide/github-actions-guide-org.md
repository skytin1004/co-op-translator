...
၂။ **Install** ကို နှိပ်ပြီး သင့်ရဲ့ repository ရှိတဲ့ account သို့မဟုတ် organization ကို ရွေးပါ။
    ...
    <img alt="Install app" src="../../../../translated_images/my/install-app.d0f0a24cbb1d6c93.webp">
...
၃။ **Only select repositories** ကို ရွေးပြီး သင့်ရဲ့ repository (ဥပမာ `PhiCookBook`) ကို ရွေးပါ။ **Install** ကို နှိပ်ပါ။ Authenticate လုပ်ဖို့ တောင်းနိုင်ပါတယ်။
    ...
    <img alt="Install authorize" src="../../../../translated_images/my/install-authorize.29df6238c3eb8f70.webp">
...
၃။ **Repository secrets** အောက်မှာ အောက်ပါ secret တစ်ခုစီအတွက် **New repository secret** ကို နှိပ်ပါ။
   ...
   <img alt="Select setting action" src="../../../../translated_images/my/select-setting-action.3b95c915d6031159.webp">
...
<img alt="Enter environment variable name" src="../../../../translated_images/my/add-secrets-done.444861ce6956d5cb.webp">
