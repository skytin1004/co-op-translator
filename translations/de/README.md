...
- [GitHub Actions Anleitung (Microsoft Organisations-Repositories & Organisationsebene)](./getting_started/github-actions-guide/github-actions-guide-org.md)
...
Begleiten Sie uns dabei, die Art und Weise zu revolutionieren, wie Bildungsinhalte weltweit geteilt werden! Geben Sie [Co-op Translator](https://github.com/azure/co-op-translator) auf GitHub einen ⭐ und unterstützen Sie unsere Mission, Sprachbarrieren im Lernen und in der Technologie abzubauen. Ihr Interesse und Ihre Beiträge haben großen Einfluss! Code-Beiträge und Feature-Vorschläge sind jederzeit willkommen.
...
- [Generative KI für Anfänger mit Java](https://github.com/microsoft/generative-ai-for-beginners-java)
