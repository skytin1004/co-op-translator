...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-08T16:04:15+00:00",
...
Dieses Projekt freut sich über Beiträge und Vorschläge. Die meisten Beiträge erfordern, dass Sie einer Contributor License Agreement (CLA) zustimmen, in der Sie bestätigen, dass Sie das Recht haben und tatsächlich die Rechte einräumen, Ihre Beiträge zu verwenden. Details finden Sie unter https://cla.opensource.microsoft.com.
...
>
> Zusätzlich zum lokalen Ausführen des Projekts können Sie auch GitHub Codespaces oder VS Code Dev Containers als alternative Entwicklungsumgebungen nutzen.
>
> #### GitHub Codespaces
>
...
1. Navigieren Sie in das Verzeichnis, in dem Sie Übersetzungstests durchführen möchten, oder erstellen Sie einen temporären Ordner zu Testzwecken.
...
Wir freuen uns über Beiträge, die neue Sprachen unterstützen. Bevor Sie eine PR eröffnen, führen Sie bitte die folgenden Schritte durch, um eine reibungslose Prüfung zu gewährleisten.
...
Wenn eine Pull-Anfrage (PR) gemerged wird, werden die einzelnen Commits zu einem einzigen Commit zusammengefasst. Die finale Commit-Nachricht sollte dem untenstehenden Format folgen, um eine saubere und konsistente Historie zu erhalten.
...
Beim Mergen achten Sie darauf, dass die finale Commit-Nachricht dem oben beschriebenen Format entspricht.
