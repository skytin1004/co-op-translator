...
Alla oleva taulukko luettelee kielet, joita **Co-op Translator** tällä hetkellä tukee. Siinä näkyvät kielikoodit, kielten nimet ja mahdolliset tunnetut ongelmat kunkin kielen kohdalla. Jos haluat lisätä tuen uudelle kielelle, lisää vastaava kielikoodi, nimi ja sopiva fontti tiedostoon `font_language_mappings.yml`, joka sijaitsee kansiossa `src/co_op_translator/fonts/`, ja tee pull request testauksen jälkeen.
...
Kiinnostaako uuden kielen lisääminen? Noudata seuraavaa ohjeistusta:

- Katso ohjeet: [Contribute a new language](../CONTRIBUTING.md#contribute-a-new-language)

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Vastuuvapauslauseke**:  
Tämä asiakirja on käännetty käyttämällä tekoälypohjaista käännöspalvelua [Co-op Translator](https://github.com/Azure/co-op-translator). Vaikka pyrimme tarkkuuteen, otathan huomioon, että automaattiset käännökset voivat sisältää virheitä tai epätarkkuuksia. Alkuperäinen asiakirja sen alkuperäiskielellä tulee pitää auktoriteettisena lähteenä. Tärkeissä tiedoissa suositellaan ammattimaista ihmiskäännöstä. Emme ota vastuuta tästä käännöksestä johtuvista väärinymmärryksistä tai virhetulkinnoista.
