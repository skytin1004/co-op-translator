...
1. **Install** निवडा आणि तुमच्या target repository असलेल्या account किंवा organization निवडा.
    ...
    <img alt="Install app" src="../../../../translated_images/mr/install-app.d0f0a24cbb1d6c93.webp">
...
1. **Only select repositories** निवडा आणि तुमचा target repository (उदा. `PhiCookBook`) निवडा. **Install** क्लिक करा. Authentication विचारले जाऊ शकते.
    ...
    <img alt="Install authorize" src="../../../../translated_images/mr/install-authorize.29df6238c3eb8f70.webp">
...
1. **Repository secrets** खाली, प्रत्येक secret साठी **New repository secret** क्लिक करा.
   ...
   <img alt="Select setting action" src="../../../../translated_images/mr/select-setting-action.3b95c915d6031159.webp">
...
<img alt="Enter environment variable name" src="../../../../translated_images/mr/add-secrets-done.444861ce6956d5cb.webp">
