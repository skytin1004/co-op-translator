...
A tabela abaixo lista as línguas atualmente suportadas pelo **Co-op Translator**. Inclui códigos de língua, nomes das línguas e quaisquer problemas conhecidos associados a cada língua. Se desejar adicionar suporte para uma nova língua, por favor adicione o código de língua correspondente, o nome e a fonte apropriada no ficheiro `font_language_mappings.yml` localizado em `src/co_op_translator/fonts/` e submeta um pull request após os testes.
...
Interessado em adicionar uma nova língua? Por favor siga o guia de contribuição:

- Ver Contributing: [Contribute a new language](../CONTRIBUTING.md#contribute-a-new-language)
