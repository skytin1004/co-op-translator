...
3.  Em **Repository secrets**, clique em **New repository secret** para cada segredo de serviço de IA necessário listado abaixo.
    ...
    <img src="../../../../translated_images/pt-PT/select-setting-action.3b95c915d6031159.webp" alt="Selecionar ação de definições"> *(Referência de Imagem: Mostra onde adicionar segredos)*
...
<img src="../../../../translated_images/pt-PT/permission-setting.ae2f02748b0579e7.webp" alt="Definição de permissões">
