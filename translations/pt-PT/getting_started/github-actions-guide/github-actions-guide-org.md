...
1. Selecione **Install** e escolha a conta ou organização onde está o seu repositório de destino.
    ...
    ![Instalar app](../../../../translated_images/pt-PT/install-app.d0f0a24cbb1d6c93.webp)
...
1. Escolha **Only select repositories** e selecione o seu repositório de destino (por exemplo, `PhiCookBook`). Clique em **Install**. Poderá ser-lhe pedido para autenticar.
    ...
    ![Instalar autorizar](../../../../translated_images/pt-PT/install-authorize.29df6238c3eb8f70.webp)
...
1. Em **Repository secrets**, clique em **New repository secret** para cada segredo listado abaixo.
   ...
   ![Selecionar definições action](../../../../translated_images/pt-PT/select-setting-action.3b95c915d6031159.webp)
...
![Introduzir nome da variável de ambiente](../../../../translated_images/pt-PT/add-secrets-done.444861ce6956d5cb.webp)
