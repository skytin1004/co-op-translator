...
Maintainers: O bloco abaixo é um exemplo "todos os idiomas" gerido pelo Co-op Translator.

- Se quiser que o Co-op Translator mantenha esta lista totalmente atualizada automaticamente quando executar `translate` (qualquer seleção de idioma), mantenha os dois marcadores de comentário tal como estão.
- Se quiser apenas mostrar um subconjunto de idiomas, elimine os dois marcadores de comentário e remova os idiomas que não quiser listar. Após remover os marcadores, o Co-op Translator deixará de substituir automaticamente esta secção.

- A secção agora inclui um aviso "Prefere Clonar Localmente?" para ajudar os utilizadores a clonar sem o grande pacote de traduções. Pode personalizar o aviso com a URL do seu repositório executando, por exemplo:
