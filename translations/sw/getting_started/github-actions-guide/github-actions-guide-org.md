...
1. Chagua **Install** na chagua akaunti au shirika ambako repo yako inalenga ipo.
    ...
    ![Install app](../../../../translated_images/sw/install-app.d0f0a24cbb1d6c93.webp)
...
1. Chagua **Only select repositories** na chagua repo yako unayotaka (mfano, `PhiCookBook`). Bonyeza **Install**. Unaweza kuombwa kuthibitisha.
    ...
    ![Install authorize](../../../../translated_images/sw/install-authorize.29df6238c3eb8f70.webp)
...
1. Chini ya **Repository secrets**, bonyeza **New repository secret** kwa kila secret iliyo kwenye orodha hapa chini.
   ...
   ![Select setting action](../../../../translated_images/sw/select-setting-action.3b95c915d6031159.webp)
...
![Enter environment variable name](../../../../translated_images/sw/add-secrets-done.444861ce6956d5cb.webp)
