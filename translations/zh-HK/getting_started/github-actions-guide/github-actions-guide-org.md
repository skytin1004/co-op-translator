...
1. 選擇 **Install**，然後選擇你的帳號或組織（即目標倉庫所在）。
    ...
    <img src="../../../../translated_images/zh-HK/install-app.d0f0a24cbb1d6c93.webp" alt="安裝 app">

1. 選擇 **Only select repositories**，然後選擇你的目標倉庫（例如 `PhiCookBook`）。按 **Install**。可能需要驗證身份。

    <img src="../../../../translated_images/zh-HK/install-authorize.29df6238c3eb8f70.webp" alt="安裝授權">
...
1. 在 **Repository secrets** 下，為下列每個 secret 按 **New repository secret**。
   ...
   <img src="../../../../translated_images/zh-HK/select-setting-action.3b95c915d6031159.webp" alt="選擇設定 action">
...
<img src="../../../../translated_images/zh-HK/add-secrets-done.444861ce6956d5cb.webp" alt="輸入環境變數名稱">
