...
Neste tutorial, vamos orientá-lo na configuração de suas variáveis de ambiente para os serviços Azure usando um arquivo *.env*. Variáveis de ambiente permitem que você gerencie de forma segura credenciais sensíveis, como chaves de API, sem precisar codificá-las diretamente no seu código.

> [!IMPORTANT]
> - Apenas um serviço de modelo de linguagem (Azure OpenAI ou OpenAI) precisa ser configurado. Preencha as variáveis de ambiente para o serviço de sua preferência. Se variáveis de ambiente para múltiplos modelos de linguagem estiverem definidas, o co-op translator selecionará uma com base na prioridade.
