...
1. Navegue para [https://ai.azure.com](https://ai.azure.com) e faça login com sua conta Azure.

1. Selecione **+Create** para criar um novo projeto.

1. Execute as seguintes tarefas:
   - Insira um **Nome do projeto** (por exemplo, `CoopTranslator-Project`).
...
1. Será apresentada uma lista de modelos disponíveis. Filtre ou pesquise por um modelo GPT adequado. Recomendamos `gpt-4o`.
...
1. Navegue para seu Projeto Azure AI (por exemplo, `CoopTranslator-Project`). Certifique-se de estar na página de visão geral do projeto.
...
1. Encontre a **Chave da API** e o **Endpoint** na aba Azure AI Service.

    ![Find API Key and Endpoint](../../../translated_images/pt-BR/find-azure-ai-info.0e00140419c12517.webp)
