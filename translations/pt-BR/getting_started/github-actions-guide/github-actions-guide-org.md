...
1. Selecione **Install** e escolha a conta ou organização onde está o repositório desejado.
    ...
    ![Instalar app](../../../../translated_images/pt-BR/install-app.d0f0a24cbb1d6c93.webp)
...
1. Escolha **Only select repositories** e selecione seu repositório alvo (ex: `PhiCookBook`). Clique em **Install**. Pode ser necessário autenticar.
    ...
    ![Instalar autorizar](../../../../translated_images/pt-BR/install-authorize.29df6238c3eb8f70.webp)
...
1. Em **Repository secrets**, clique em **New repository secret** para cada segredo listado abaixo.
   ...
   ![Selecionar configuração action](../../../../translated_images/pt-BR/select-setting-action.3b95c915d6031159.webp)
...
![Digite o nome da variável de ambiente](../../../../translated_images/pt-BR/add-secrets-done.444861ce6956d5cb.webp)
