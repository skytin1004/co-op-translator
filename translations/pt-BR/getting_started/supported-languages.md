...
A tabela abaixo lista os idiomas atualmente suportados pelo **Co-op Translator**. Ela inclui códigos de idioma, nomes dos idiomas e quaisquer problemas conhecidos associados a cada idioma. Se você deseja adicionar suporte para um novo idioma, adicione o código de idioma correspondente, o nome e a fonte apropriada no arquivo `font_language_mappings.yml` localizado em `src/co_op_translator/fonts/` e envie um pull request após os testes.
...
Interessado em adicionar um novo idioma? Por favor, siga o guia de contribuição:

- Veja Contributing: [Contribute a new language](../CONTRIBUTING.md#contribute-a-new-language)
