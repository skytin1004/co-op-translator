...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-22T12:16:28+00:00",
...
- Препорука: Ако имате преводе направљене другим алатима, прво их очистите да избегнете конфликте (на пример: `translations/`).
...
Придружите нам се у револуцији дељења едукативног садржаја широм света! Дајте [Co-op Translator](https://github.com/azure/co-op-translator) ⭐ на GitHub-у и подржите нашу мисију рушења језичких баријера у учењу и технологији. Ваше интересовање и доприноси чине велику разлику! Доприноси у коду и предлози за нове функције су увек добродошли.
...
- [Генеративни AI за почетнике са .NET](https://github.com/microsoft/Generative-AI-for-beginners-dotnet)
- [Генеративни AI за почетнике](https://github.com/microsoft/generative-ai-for-beginners)
- [Генеративни AI за почетнике са Java](https://github.com/microsoft/generative-ai-for-beginners-java)
...
Овај пројекат поздравља доприносе и предлоге. Желите да допринесете Azure Co-op Translator-у? Погледајте наш [CONTRIBUTING.md](./CONTRIBUTING.md) за смернице како можете помоћи да Co-op Translator буде приступачнији.
