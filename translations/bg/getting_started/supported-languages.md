...
Таблицата по-долу изброява езиците, които в момента се поддържат от **Co-op Translator**. Тя включва езикови кодове, наименования на езици и всички известни проблеми, свързани с всеки език. Ако искате да добавите поддръжка за нов език, моля добавете съответния езиков код, име и подходящ шрифт във файла `font_language_mappings.yml`, намиращ се в `src/co_op_translator/fonts/`, и изпратете pull request след като направите тестове.
...
Интересувате ли се да добавите нов език? Моля, следвайте ръководството за принос:

- Вижте Contributing: [Contribute a new language](../CONTRIBUTING.md#contribute-a-new-language)
