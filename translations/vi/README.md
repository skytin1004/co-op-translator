...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-22T13:57:59+00:00",
...
Thêm cờ lệnh: [Tham khảo lệnh](./getting_started/command-reference.md)

## Tính năng

- Tự động dịch Markdown, notebook và hình ảnh
- Giữ cho các bản dịch luôn đồng bộ với thay đổi nguồn
- Hoạt động trên máy cá nhân (CLI) hoặc trong CI (GitHub Actions)
...
Microsoft cam kết giúp khách hàng sử dụng sản phẩm AI một cách có trách nhiệm, chia sẻ kinh nghiệm và xây dựng quan hệ đối tác dựa trên sự tin tưởng thông qua các công cụ như Transparency Notes và Đánh giá tác động. Nhiều tài nguyên này có tại [https://aka.ms/RAI](https://aka.ms/RAI).
