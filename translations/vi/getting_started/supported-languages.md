...
Bảng dưới đây liệt kê các ngôn ngữ hiện đang được **Co-op Translator** hỗ trợ. Nó bao gồm mã ngôn ngữ, tên ngôn ngữ và bất kỳ vấn đề đã biết nào liên quan đến từng ngôn ngữ. Nếu bạn muốn thêm hỗ trợ cho một ngôn ngữ mới, vui lòng thêm mã ngôn ngữ tương ứng, tên và phông chữ phù hợp vào file `font_language_mappings.yml` nằm trong `src/co_op_translator/fonts/` và gửi một pull request sau khi kiểm tra.

| Mã ngôn ngữ  | Tên ngôn ngữ         | Phông chữ                        | Hỗ trợ RTL  | Vấn đề đã biết |
|---------------|----------------------|---------------------------------|-------------|----------------|
...
| pt-PT         | Tiếng Bồ Đào Nha (Bồ Đào Nha) | NotoSans-Medium.ttf     | Không       | Không         |
| pt-BR         | Tiếng Bồ Đào Nha (Brazil) | NotoSans-Medium.ttf           | Không       | Không         |
| it            | Tiếng Ý              | NotoSans-Medium.ttf             | Không       | Không         |
| lt            | Tiếng Lithuania      | NotoSans-Medium.ttf             | Không       | Không         |
...
| sk            | Tiếng Slovakia       | NotoSans-Medium.ttf             | Không       | Không         |
| ro            | Tiếng Rumani         | NotoSans-Medium.ttf             | Không       | Không         |
| bg            | Tiếng Bungari        | NotoSans-Medium.ttf             | Không       | Không         |
| sr            | Tiếng Serbia (Chữ Kirin) | NotoSans-Medium.ttf          | Không       | Không         |
...
Quan tâm đến việc thêm một ngôn ngữ mới? Vui lòng làm theo hướng dẫn đóng góp:

- Xem Mục Đóng góp: [Đóng góp một ngôn ngữ mới](../CONTRIBUTING.md#contribute-a-new-language)

---

<!-- CO-OP TRANSLATOR DISCLAIMER START -->
**Tuyên bố từ chối trách nhiệm**:  
Tài liệu này đã được dịch bằng dịch vụ dịch thuật AI [Co-op Translator](https://github.com/Azure/co-op-translator). Mặc dù chúng tôi cố gắng đảm bảo độ chính xác, xin lưu ý rằng bản dịch tự động có thể chứa lỗi hoặc không chính xác. Tài liệu gốc bằng ngôn ngữ bản địa nên được coi là nguồn chính xác và đáng tin cậy. Đối với các thông tin quan trọng, nên sử dụng dịch vụ dịch thuật chuyên nghiệp do con người thực hiện. Chúng tôi không chịu trách nhiệm cho bất kỳ sự hiểu lầm hoặc sai diễn nào phát sinh từ việc sử dụng bản dịch này.
